...
//        t2.setKaupat(Arrays.asList(k3));
		...
		List<Object[]> shops = manageri.createQuery(
				"Select k, t from Kauppa k INNER JOIN k.tuotteet t", Object[].class)
				.getResultList();
		for (Object[] row : shops) {
			System.out.println(row[0] + " " + row[1]);
		}

		List<Object[]> results = manageri.createQuery(
				"Select k.id, k.nimi, t.id, t.nimi from Kauppa k INNER JOIN k.tuotteet t", Object[].class)
				.getResultList();
